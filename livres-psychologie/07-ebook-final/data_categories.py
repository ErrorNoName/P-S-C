    ...
    },
    {
        ...
        "sections": [
            ...
            ("La clinique, une spécialité dans la psychologie",
             ...
             "elles, sont bien plus anciennes. Rien dans ces pages ne permet de poser un diagnostic.</p>"),
            ...
            ("Pinel, Esquirol, et l'histoire de la folie",
             ...
             "(<em>Des maladies mentales</em>, 1838). <strong>Michel Foucault</strong>, "
             "<em>Histoire de la folie à l'âge classique</em> (1961), raconte comment on a nommé, enfermé "
             "et soigné la folie : c'est une histoire des institutions, pas un manuel de soin.</p>"
             ...
             "<p>Le mot <strong>santé mentale</strong> relève de la santé publique, de l'administration, "
             "de la psychiatrie et de la psychopathologie. Décrire une population n'est pas rencontrer "
             "un sujet. Ce glissement de vocabulaire, en France comme ailleurs en Europe, a pu élargir "
             "l'accès aux soins et, en même temps, inquiéter les cliniciens : à force de catégories "
             "générales, le soin au cas par cas s'amincit. Les deux mouvements sont réels. Aucun des "
             "deux ne se règle par un slogan.</p>"),
            ("Expliquer n'est pas comprendre",
             ...
             "(<em>Psychopathologie générale</em>, 1913).</p>"
             "<p>Les conseils de santé sont rationnels (ne pas fumer, dormir, manger). "
            ...
            ("Psychologue et psychiatre",
             ...
             "pour elle-même ou pour autrui. Ce ne sont pas des punitions. "
             "Ces pages ne décrivent pas comment les mettre en œuvre.</p>"),
            ("Witmer, 1896 : la première clinique psychologique",
             ...
             "<p>En 1919, l'APA ouvre une section de psychologie clinique. Quatre tâches structurent "
             "encore la formation : étude des cas individuels ; contribution à l'évaluation ; bilans ; "
             "prises en charge individuelle et collective. Aux États-Unis, la conférence de Boulder (1949) "
             "ajoute le modèle scientifique-praticien. En France, l'évaluation psychologique n'est pas un "
             "diagnostic médical. Une lecture seulement neurobiologique de la souffrance manque la personne.</p>"),
            ("Janet : penser la maladie, pas seulement la panser",
             ...
             "voient des malades mentaux. Deux verbes suffisent : <strong>penser</strong> la "
             "maladie, pas seulement la <strong>panser</strong>. Janet n'est pas le fondateur de la "
             "médecine psychosomatique. Son geste est plus limité, et juste : former le médecin "
             "à une lecture psychologique, appuyée sur la philosophie, pas sur la seule lésion.</p>"
             "<p>Trois apports en découlent :</p>"
            ...
            ("Le cas, le laboratoire et le milieu de vie",
             ...
             "artificiel, et le fait d'être observé change déjà le sujet. L'observation dans la vie "
             "ordinaire cherche des <strong>raisons</strong> autant que des causes. Les deux démarches "
             "sont utiles. Elles ne décrivent pas le même objet. La psychologie clinique commence par "
             "la seconde : la personne là où elle vit.</p>"),
            ("Normal et pathologique : une différence de degré",
             "<p>Il n'y a pas de coupure nette entre un « homme sain » et un « homme malade ». "
             "Entre un état psychique ordinaire et un état très douloureux, il y a souvent une différence "
             "d'<strong>intensité</strong>, pas une autre espèce d'humanité. Janet le soutient déjà. "
             "<strong>Georges Canguilhem</strong>, <em>Le normal et le pathologique</em> (1943, repris en "
             "1966), en donne la forme philosophique. Le <strong>spectre de l'autisme</strong> montre "
             "la même idée avec prudence : il n'y a pas une seule forme. Certaines personnes aménagent "
             "travail, liens et quotidien et vivent de façon adaptée. Un mot posé trop tôt sur un enfant "
             "en plein développement peut figer ce qui bouge encore. Une étiquette n'est ni une "
             "condamnation, ni un destin.</p>"
             "<p>Continuité ne veut pas dire mêmes processus. Éveillée, une personne ne vole pas et ne "
             "se soustrait pas à la pesanteur ni aux interdits sociaux. Dans le rêve, la même personne "
             "peut voler ou franchir un interdit. L'état onirique n'obéit pas au même "
             "<strong>principe de réalité</strong>. Deux fonctionnements, une seule vie.</p>"),
            ("La personne totale en situation",
             "<p>Recevoir quelqu'un, c'est le prendre dans sa globalité : un corps, une histoire, et les "
             "systèmes où il vit — famille, travail, école, soin. On n'isole pas un fragment pour en "
             "faire « le » problème. On regarde comment les éléments agissent ensemble. Un soignant pressé "
             "ne voit plus que l'organe ou le symptôme. La personne qui souffre a aussi un métier, des "
             "liens, un âge, un monde.</p>"
             "<p><strong>Lagache</strong> fixe cet objet en 1949, dans <em>L'unité de la psychologie</em> : "
             ...
             "situation</strong>. Elle concerne aussi celui qui n'est pas malade. "
             "<strong>Juliette Favez-Boutonnier</strong> appelle <strong>clinique à mains nues</strong> "
             "l'observation et l'entretien, avant tout test. La clinique « armée » ajoute des épreuves. "
             "Elle ne remplace pas la rencontre.</p>"
             "<p>Quatre gestes tiennent alors ensemble. Aller au chevet, au sens figuré : être auprès. "
             "Comprendre le sens, pas seulement expliquer une cause. Garder le singulier, sans le dissoudre "
             "dans une moyenne. Situer la conduite dans une vie. Les familles de troubles qui suivent "
             "décrivent des syndromes, des durées, un retentissement. Elles partent de là : une personne, "
             "pas une étiquette collée d'avance.</p>"
             "<p>Les textes de référence sont ceux de Witmer (<em>The Psychological Clinic</em>, 1907), "
             "Lagache (1949), Jaspers (<em>Psychopathologie générale</em>, 1913), Canguilhem "
             "(<em>Le normal et le pathologique</em>) et Foucault (<em>Histoire de la folie à l'âge "
             "classique</em>). Le cadre du métier est le "
             "<a href=\"https://psychologues.org/la-deontologie\" target=\"_blank\" rel=\"noopener\">code "
             "de déontologie des psychologues</a>. Sur expliquer et comprendre, l'article de Kumazaki "
             "relit Jaspers à partir de Dilthey (<a href=\"https://pmc.ncbi.nlm.nih.gov/articles/PMC4995496\" "
             "target=\"_blank\" rel=\"noopener\">PMC4995496</a>).</p>"),
