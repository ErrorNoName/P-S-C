  ...
  <section class="cahier-home" id="cahier-home">
    <header class="cahier-home-head">
      ...
      <div class="cahier-home-actions">
        ...
        <button type="button" class="btn btn-secondary" id="cahier-import">Importer</button>
        <button type="button" class="btn btn-secondary" id="cahier-drive">Enregistrer dans Drive</button>
        <input type="file" id="cahier-file" accept=".docx,application/vnd.openxmlformats-officedocument.wordprocessingml.document" multiple hidden>
      </div>
    </header>
    <div class="gdoc-box" id="import-box" hidden>
      <p class="cahier-lead">D'où viennent les documents ?</p>
      <div class="cahier-home-actions">
        <button type="button" class="btn btn-primary" id="import-local">Cet appareil</button>
        <button type="button" class="btn btn-secondary" id="import-drive">Google Drive</button>
      </div>
      <div id="import-drive-list" class="import-list" hidden></div>
      <button type="button" class="btn btn-primary" id="import-drive-go" hidden>Importer la sélection</button>
    </div>
